...
| Network meta-analysis | connected competing interventions plus transitivity variables | design-appropriate RoB; CINeMA/GRADE for network certainty | PRISMA-NMA plus current update status; consistency and transitivity assessment |
...
| Umbrella review / overview | systematic reviews as included units | ROBIS for bias; AMSTAR 2 for methodological quality where applicable | overlap matrix, corrected covered area, no double-counting of primary studies |
