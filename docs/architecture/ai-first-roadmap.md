...
- [x] VAL-1: Select and license-review the first published-review reconstruction families without contaminating the held-out split. Eighteen formally identified reviews are in the broad discovery catalog and four are in the strict registry. Five immutable material plans now cover BMJ living-NMA method code, the PLOS living-DTA pair, carbon-pricing screening, SCI extraction-to-analysis and HEPSANET controlled-IPD guards. **2026-08-18: first promotion completed — sci-exercise-analysis (dev split, analysis slice; BSD-3-Clause complete, sealed input hashed, sealed answers extracted from the published article with source locators, three locked repetitions scored pass)** (`val1-promotion-analysis-2026-08-18.md`, `reconstruction-first-case-results-2026-08-18.md`).
...
- [ ] VAL-2b2: Fill and freeze the reconstruction-case task manuals (blocked on VAL-1 promotion of the five benchmark families). **2026-08-18: first case manual sealed — sci-exercise analysis slice (case spec + sealed answers + tolerances); remaining families open.**
- [x] VAL-2c: Freeze the 100-item human-blind appraisal-domain spot-check (weak-label rule-clarity measurement) with a sealed answer key and SHA-256 manifest; **rated 2026-08-18: kappa 0.311 (0.191–0.431) → rule revision + new generation required (protocol §5)** (protocol: `appraisal-human-blind-spotcheck-protocol-2026-08-18.md`; result: `val2c-scoring-result-2026-08-18.md`).
- [ ] VAL-3: Run the AI-only configuration/ablation pilot and measure critical error, coverage, accuracy, cost, reliability, position sensitivity, and judge-order sensitivity. **2026-08-18: dev rehearsal complete for the first reconstruction case (deterministic-r-analysis ×3, scoring passed); the AI-only LLM configurations remain open.**
