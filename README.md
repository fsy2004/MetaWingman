...
| **双盲全流程重建(vs 已发表评价)** | 只看临床问题(双盲):设计=诊断准确性✓、pooling✓、分析模型(双变量 DTA)✓、**纳入标准 8/8 维度✓**;分析阶段用同一证据语料(185 研究 2×2,heiDATA 工作簿)重建:灵敏度 **72.7%** [70.1–75.2] vs 发表 72.0% [69.8–74.2](Δ+0.70pp)、特异度 **99.1%** [98.9–99.3] vs 98.9% [98.6–99.1](Δ+0.20pp),均在预注册 ±2.0pp 容差内 | research/blind-reconstruction-agrdt.json + research/reconstruction-agrdt-pooled-v2.json + scripts/reconstruction_agrdt.R | 锚点:Brümmer et al. PLoS Med 2022(living DTA);双盲=agent 仅见临床问题;搜索/筛选不在本重建范围(已声明) |
