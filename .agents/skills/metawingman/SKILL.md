...
3. Select the review profile before choosing databases, appraisal tools, or models. Read [review-types.md](references/review-types.md) and use the source hierarchy in [methodology-source-registry.md](references/methodology-source-registry.md).
